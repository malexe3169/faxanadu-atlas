...
| [movie-maker](movie-maker) | 1.0 | Atlas Movie Maker : faites l'intro, la fin ou une cinématique de Faxanadu dans votre navigateur, à partir de votre ROM, et recevez une ROM patchée ou un IPS. Écrit aussi le fichier de config pour un projet FaxEdit. | USA, et les mods bâtis dessus |
