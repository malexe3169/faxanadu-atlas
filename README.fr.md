...
| [faxedit-hack-compatibility-9.2](faxedit-hack-compatibility-9.2) | 9.2-5 | Quels hacks généraux de FaxEdit 9.2 fonctionnent ensemble, plus les hacks pas encore dans FaxEdit, marqués : chaque paire bâtie dans les deux ordres, les paires qui ne marchent pas et pourquoi. | FaxEdit 9.2 |
| [custom-build](custom-build) | 9.2-3 | Demandez un patch avec les hacks de FaxEdit de votre choix : une page qui les vérifie, un formulaire de demande, et des patches IPS et BPS bâtis pour vous. | USA, USA Rev 1, Europe |
