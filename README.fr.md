...
| [movie-maker](movie-maker) | 1.2.1 | Atlas Movie Maker : faites l'intro, la fin ou une cinématique de Faxanadu dans votre navigateur, à partir de votre ROM : glissez les acteurs, tracez leurs trajets sur l'image, et recevez une ROM patchée ou un IPS. Un script démarre un film en affichant un message qui dit MOVIE-nom. Écrit aussi le fichier de config pour un projet FaxEdit. | USA, et les mods bâtis dessus |
