...
| [faxedit-hack-compatibility-9.2](faxedit-hack-compatibility-9.2) | 9.2-2 | Which FaxEdit 9.2 general hacks work together, plus the hacks not in FaxEdit yet, marked: every pair built in both orders, the pairs that don't work, and why. | FaxEdit 9.2 |
