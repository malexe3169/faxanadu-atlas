...
| [movie-maker](movie-maker) | 2.0 | Atlas Movie Maker 2: one picture, drag the actors and draw their paths, Play boots the game in the page with sound, templates, captions in the game's font, art from your images, undo. Your ROM stays in your browser; you get back an IPS. The 1.7 page stays at movie-maker/classic. | USA, and mods built from it |
