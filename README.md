...
| [movie-maker](movie-maker) | 1.0 | Atlas Movie Maker: make the intro, the ending or a cutscene of Faxanadu in your browser, from your own ROM, and get back a patched ROM or an IPS. Also writes the config file for a FaxEdit project. | USA, and mods built from it |
