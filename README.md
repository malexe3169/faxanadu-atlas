...
| [movie-maker](movie-maker) | 1.3 | Atlas Movie Maker: make the intro, the ending or a cutscene of Faxanadu in your browser, from your own ROM: drag the actors, draw their paths on the picture, and get back a patched ROM or an IPS. A script starts a movie by showing a message that reads MOVIE-name. Also writes the config file for a FaxEdit project. | USA, and mods built from it |
