...
| [custom-build](custom-build) | 9.2-1 | Ask for a patch with the FaxEdit hacks you pick: a page that checks them, a request form, and IPS and BPS patches built for you. | USA, USA Rev 1, Europe |
